...
/* Macro for unused attribute */
#define UNUSED __attribute__((unused))

/* Size of the buffer for each read call in _getline */
...
"	When there are not correct numbers of arguments, an error message is printed.\n\n"
...
"	specified, detailed help on all commands matching BUILTIN_NAME is given,\n"\
"	otherwise the list of help topics is printed. The arguments are:\n\n"\
