...
/**
 * shell_str_length - returns the length of a string.
...
/**
 * shell_str_duplicate - duplicates a string.
...
char *shell_str_duplicate(char *string)
{
	...
	length = shell_str_length(string) + 1;
...
/**
 * shell_str_compare - Compare two strings.
...
int shell_str_compare(char *string1, char *string2, int number)
{
	...
	{
		if (shell_str_length(string1) != shell_str_length(string2))
			return (0);
...
/**
 * shell_str_concat - concatenates two strings.
...
char *shell_str_concat(char *string1, char *string2)
{
	...
	if (string1 == NULL)
		string1 = "";
	length1 = shell_str_length(string1);

	if (string2 == NULL)
		string2 = "";
	length2 = shell_str_length(string2);
...
/**
 * shell_str_reverse - reverses a string.
 * @string: pointer to string.
 * Return: void.
 */
void shell_str_reverse(char *string)
{
	int i = 0, length = shell_str_length(string) - 1;
	char hold;
